...
A technical difficult of the LTRM is that some parameters are poorly identified. For instance, given a positive real numbers $c$, $\kappa_\Irater / \zeta_\Irater = (c\kappa_\Irater) / (c\zeta_\Irater)$. Hence, different parameters values may yield an identical likelihood. Such identification problems are avoided by restricting the mean of a parameter vector to 0 whenever necessary.
...
\begin{figure}[!ht]
%	\missingfigure{parameter recovery}
	\centering
