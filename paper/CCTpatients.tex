...
% -          Rob Flohr en ik zijn beide verbonden aan NHL Stenden University of Applied Sciences
%
%-          In de titel en door de hele tekst staat : Psychiatric Detention Centers. Dit zijn in Nederland de psychiatrische afdelingen van de gevangenissen. Je kunt volgens mij het beter hebben over Forensic Psychiatric Hospitals, dit zijn de tbs-klinieken waarin men halfjaarlijks verplicht is de benadeling te evalueren door het team (de zg Wettelijke aantekeningen)
%
%-          Eigenlijk wordt er gescoord naast mental health scores ook gescoord op forensic risk items. Mental health scores zijn bijvoorbeeld angst en depressie, terwijl het specifieke in een tbs kliniek de risico (gedrag) items zijn van de risicotaxatie instrumenten
%
%-          Wat is het onderscheid tussen een clinician en een psychiater? In een behandelteam zitten veel disciplines: psycholoog, psychiater, sociotherapeut, maatschappelijk werk, vaktherapeut, psychotherapeut, etc. In de Mesdag scoren al deze disciplines halfjaarlijks het gedrag van de patient middels de IFTE- Instrument for Forensic Treatment Evaluation (zie bijgevoegd artikel).
%
%-          De limitatie van de CCT dat het alleen op 1 patiënt kan worden toegepast is op zich geen limitatie, het is al heel wat dat dit bedacht en mogelijk is (p2). In de praktijk is de behandeling zeer geïndividualiseerd met de focus op de verandering binnen een persoon. Maar ik snap je punt dat de between info ook relevant kan zijn vanuit een ander gezichtspunt.
%
%-          Ik heb wat moeite om figuur 1 te lezen: ik mis de error van de appraisal in het plaatje, of heb je die vervangen door de variantie van de appraisal error? Komt misschien dat de error van de appraisal in de legenda staat.
%
%-          P4 the appraissal Yri is latent and thus we consider the prob that an appraisal fails in ….. Bedoel je falls?
%
%-          P6/p7 Sex offenders are typically less aggressive than violent offenders. Moordenaars zijn over het algemeen niet zo agressief in de behandeling.
%
%-          Wat betreft de methode daar moet ik me nog verder in verdiepen, maar ik zou ook nog opmerken dat men indien met dit model gaat werken in de praktijk zich ervan bewust dient te zijn dat er een aantal assumptie worden gedaan die van invloed zijn op de interpretaties.
